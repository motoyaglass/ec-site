...
7. 「アクセス状況」で、サイトの閲覧数(本日・過去7日・過去30日・累計、直近14日間の推移)に加えて、時間帯別アクセス(日本時間)・商品クリック数・流入元(検索エンジン/SNS/直接・ブックマーク/その他)・デバイス種別(PC/モバイル/タブレット)といったマーケティング分析データを確認できます(管理画面自体へのアクセスは含みません)
